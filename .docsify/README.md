...
`generate-sidebar.mjs` tạo `_sidebar.md` từ mọi file Markdown đã được theo dõi trong repository, ở mọi độ sâu. Sidebar giữ nguyên cây thư mục nên vẫn dễ định vị khi tài liệu tăng lên.
