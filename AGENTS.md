...
8. Sửa Docsify/GitHub Pages hoặc khi người dùng yêu cầu preview/deploy docs: dùng `$deploy-github-pages`; Agent chạy `node ./.docsify/generate-sidebar.mjs` ngay trước commit/push. Sidebar được sinh từ Markdown có trong repository, không sửa tay.
