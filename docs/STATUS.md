...
1. **Triển khai FT-057 Catalog bulk reconciliation**: tạo typed stage/partition progress, seal rồi build workset/unit một lần, thay page-loop bằng atomic set-based unit reconciliation và grouped snapshot, thay relay hash-scan/wave barrier; qualification dùng một combined clock từ first Catalog receive tới final broker ack.
