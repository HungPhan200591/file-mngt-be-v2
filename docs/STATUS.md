...
4. **`BT-09D — Catalog bulk reconciliation` (`FT-062 FEASIBILITY_FAILED; FT-061 correctness stable`)**: FT-062 thay mutable reduction hydration bằng target mapping tương ứng production V23. Existing-subject path và 25K x3 pass (`2.715–3.470 ms`, exact cardinality, zero lock wait/deadlock), nhưng physical 1M vượt 90 giây khi cả hai backend vẫn active trong subject-upsert CTE. Không sửa production V23 và không chạy combined. Xem [evidence](../apps/catalog-service/src/test/java/com/filemngt/v2/catalog/benchmark/results/09-ft062-subject-target-mapping.md).
