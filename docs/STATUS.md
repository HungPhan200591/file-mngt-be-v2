...
- Feature active: `002-catalog-vertical-slice` (Plan READY; code chờ P0 runtime verification).

## Việc kế tiếp

1. Chọn JDK 25 trong IntelliJ project rồi chạy kiểm tra build/Docker P0 khi được người dùng cho phép.
2. Triển khai `002-catalog-vertical-slice` sau khi P0 được xác minh.
