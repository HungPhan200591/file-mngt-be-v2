...
4. **`BT-09D — Catalog bulk reconciliation` (`FT-058 FUNCTIONAL VERIFIED — benchmark pending`)**: FT-057 data plane đã implement, nhưng combined 25K ngày 2026-08-22 từng phát hiện seal deadlock và DLT partition mismatch nên run cũ không tạo throughput evidence hợp lệ. [FT-058](./features/058-catalog-operation-reliability-hardening/03-plan.md) đã tách seal coordinator, harden retry/DLT, thêm total deadline 120s và concurrent/failure tests. Compile + unit + PostgreSQL/Kafka regression ngày 2026-08-22 đạt `35/35 PASS`; Flyway V24 migrate thành công trên PostgreSQL 18 Testcontainers. Benchmark 25K/1M chưa chạy nên chưa có throughput evidence; không rewrite reconciliation SQL trước khi reliability gate pass.
