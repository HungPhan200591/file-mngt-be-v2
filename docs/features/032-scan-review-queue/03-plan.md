...
- Owner: `scan-service` / `scan_db`; consumer FE là module `scan` ở
  `D:\Study\Project\file_mngt_fe_v2` qua Gateway.
- Scope/files: Scan OpenAPI, controller/query/decision/repository/DTO/test, có thể
  ...
  `D:\Study\Project\file_mngt_fe_v2\docs\features\005-scan-review-queue`;
...
1. Đọc `D:\Study\Project\file_mngt_fe_v2\AGENTS.md` và
