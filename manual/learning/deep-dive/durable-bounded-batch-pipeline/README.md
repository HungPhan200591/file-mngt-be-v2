...
Local project reference: `D:\Study\Project\live-stream-backend`.
...
- LiveStream local project: `D:\Study\Project\live-stream-backend` — current baseline phải đọc trước
