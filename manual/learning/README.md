...
3. Mở [Use case study hub](./use-cases/README.md) và làm một use case đến hết study pack trước khi chuyển use case.
...
- [`use-cases/`](./use-cases/README.md): scenario nghiệp vụ lớn, tiến độ và liên kết artifact.
