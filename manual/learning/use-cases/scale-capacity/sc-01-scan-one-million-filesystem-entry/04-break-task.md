...
| **BT-09C — Outbox drain** | Continuous drain, bounded in-flight, deadline/backpressure, lease budget và partition-key ordering. | **`READY`** ([FT-052](../../../../../docs/features/052-outbox-continuous-drain/03-plan.md)) | Có publish latency, backlog age, lease-loss, duplicate và broker-failure evidence. |
