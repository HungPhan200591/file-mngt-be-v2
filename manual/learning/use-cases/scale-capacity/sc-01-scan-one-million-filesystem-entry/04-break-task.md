...
| ↳ **BT-09D1 — Fast Ingest Path** | Typed CSV COPY, giữ raw payload, precompute stable lane hash trong Java và bỏ wrapper JSON parse/cast trong stage SQL. | **`DONE`** ([FT-055](../../../../../docs/features/055-catalog-typed-ingest/03-plan.md)) | Isolated Ingest 1M đạt `20.4s` (~48.8k rec/s); Kafka Consumer 1M đạt `32.2s` (~31.0k rec/s) với 8 workers. |
