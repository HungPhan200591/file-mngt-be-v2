...
| **`BT-09D`** | Append-only Ingest, One-time Reduction, Bulk Reconciliation, Indexed Sliding Relay | [ref-bt09d-catalog-batch-coalescing.md](./references/ref-bt09d-catalog-batch-coalescing.md) |
