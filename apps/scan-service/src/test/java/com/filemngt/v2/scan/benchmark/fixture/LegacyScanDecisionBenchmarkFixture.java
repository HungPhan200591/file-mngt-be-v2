...
/** Fixture PostgreSQL synthetic cho baseline legacy approve-all decision. */
public final class LegacyScanDecisionBenchmarkFixture {
    public static final String ROOT_KEY = "benchmark-legacy-decision";

    private LegacyScanDecisionBenchmarkFixture() {}
    ...
    public static UUID seed(JdbcTemplate jdbcTemplate, int proposalCount) {
        ...
        jdbcTemplate.update("""
                ...
                SELECT gen_random_uuid(), ?,
                       'legacy-benchmark/' || lpad(value::text, 8, '0') || '.mp4',
                       'JOKE_VIDEO', 'VIDEO',
