...
| **`BENCH-04`** | **Approval Decision & Outbox** | Legacy JPA approve-all baseline → chunked replacement | 1.000.000 decisions | **25k: 4.139s; 1M: parameter-limit crash** | **6.040 records/s @25k** | [Báo cáo legacy approval](file:///d:/Personal/file-management/v2/file-mngt-be-v2/apps/scan-service/src/test/java/com/filemngt/v2/scan/benchmark/results/05-legacy-approval-decision-batch-baseline.md) |
...
4. 🧱 **[05-legacy-approval-decision-batch-baseline.md](file:///d:/Personal/file-management/v2/file-mngt-be-v2/apps/scan-service/src/test/java/com/filemngt/v2/scan/benchmark/results/05-legacy-approval-decision-batch-baseline.md)**: 25k hoàn tất trong 4.139s; 1M bị chặn bởi giới hạn 65.535 bind parameters ở `findAllById()`.
